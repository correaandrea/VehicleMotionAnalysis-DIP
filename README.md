# Vehicle Motion Analysis via Computer Vision
...
* **Member 3:** Simón Sanchez Sepúlveda | ID: [Number]

## Technologies
* **Language:** Python 
* **Core Libraries:**
    * [OpenCV](https://opencv.org/): For image processing and computer vision tasks.
    * [NumPy](https://numpy.org/): For matrix manipulation and numerical computations.
    * [Matplotlib](https://matplotlib.org/): For data visualization and plotting graphs.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/correaandrea/VehicleMotionAnalysis-DIP.git
